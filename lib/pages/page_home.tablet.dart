...
const String tabletlistItemTitleText = "A BETTER BLOG FOR WRITING";
const String tabletListItemPreviewText =
...
class PageHomeTablet extends StatelessWidget {
  static const String name = 'list';

  const PageHomeTablet({Key? key}) : super(key: key);
